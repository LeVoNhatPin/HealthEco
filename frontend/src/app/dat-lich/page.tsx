...
export default function BookingPage() {
    ...
    useEffect(() => {
        const load = async () => {
            ...
            try {
                ...
                const enhancedDoctors = doctorList.map((doctor: any) => ({
                    ...doctor,
                    rating: doctor.rating || 4.5 + Math.random() * 0.5,
                    experience: doctor.experience || Math.floor(Math.random() * 20) + 5,
                    bio: doctor.bio || "Chuyên gia với nhiều năm kinh nghiệm",
                    clinic: doctor.clinic || "Bệnh viện Đa khoa Quốc tế",
                ...
                const fees = enhancedDoctors.map((d: any) => d.consultationFee || 0);
                const maxFeeValue = Math.max(...fees, 1000000);
    ...
    const handleDateChange = async (dateStr: string) => {
        ...
        try {
            // Generate mock slots for better UI
            const mockSlots = [
                ...
                {step === 1 && (
                    <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 md:p-8">
                        <div className="mb-8">
                            <div className="flex flex-col md:flex-row md:items-center justify-between mb-6">
                                <div>
                                    ...
                                    <p className="text-gray-600">
                                        {filteredDoctors.length} bác sĩ có sẵn
                                    </p>
                                </div>
                            ...
                            {/* Filter Section */}
                            <Card className="bg-gradient-to-r from-blue-50 to-indigo-50 border-none shadow-lg mb-8">
                                <CardContent className="p-6">
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                        ...
                                        <select
                                            className="border border-gray-300 rounded-lg px-4 py-2 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                            value={specId}
                                        ...
                                        <div className="flex items-center space-x-2">
                                            ...
                                            <span className="text-blue-600 font-semibold">
                                                {minFee.toLocaleString()} - {maxFee.toLocaleString()} VNĐ
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-3">
                                        <div className="flex justify-between text-sm text-gray-600">
                                            <span>0 VNĐ</span>
                                            <span>{maxFee.toLocaleString()} VNĐ</span>
                                        </div>
                        ...
                        {loadingDoctors ? (
                            ...
                            <div className="text-center py-12">
                                ...
                                <h3 className="text-lg font-semibold text-gray-700 mb-2">Không tìm thấy bác sĩ</h3>
                                <p className="text-gray-500 mb-6">Hãy thử điều chỉnh bộ lọc để tìm kiếm</p>
                                <Button onClick={() => {
                                    setSearch("");
                                    setSpecId("");
                                    setMinFee(0);
                                        ...
                                        <CardContent className="p-6">
                                                ...
                                                <div className="ml-4 flex-1">
                                                    <div className="flex items-start justify-between">
                                                        ...
                                                        <div className="flex items-center bg-gradient-to-r from-amber-100 to-amber-50 px-2 py-1 rounded-full">
                                                            ...
                                                            <span className="ml-1 font-bold">{doctor.rating?.toFixed(1) || "4.5"}</span>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="flex items-center text-sm text-gray-600 mt-3 space-x-4">
                                                        <div className="flex items-center">
                                                            ...
                                                            <span>{doctor.experience || 10} năm</span>
                                                        </div>
                                                        <div className="flex items-center">
                                            ...
                                            <div className="mb-4">
                                                <p className="text-gray-600 text-sm line-clamp-2">
                                                    {doctor.bio || "Chuyên gia với nhiều năm kinh nghiệm"}
                                                </p>
                                            </div>
                                            ...
                                            <div className="flex items-center justify-between pt-4 border-t">
                                                <div>
                                                    <div className="text-2xl font-bold text-gray-900">
                                                        {doctor.consultationFee?.toLocaleString() || "300,000"} VNĐ
                                                    </div>
                            ...
                            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6 mb-8">
                                <div className="flex items-center">
                                    <Avatar className="h-14 w-14 border-4 border-white shadow">
                                        ...
                                        <AvatarFallback className="bg-gradient-to-r from-blue-500 to-blue-600 text-white">
                                            {selectedDoctor.user?.fullName?.split(' ').map((n: string) => n[0]).join('')}
                                        </AvatarFallback>
                                    </Avatar>
                                    <div className="ml-4">
                                        ...
                                        <div className="flex items-center space-x-2 mt-1">
                                            <Badge className="bg-gradient-to-r from-blue-100 to-blue-50 text-blue-800">
                                                {selectedDoctor.specialization?.name || "Chuyên khoa"}
                                            </Badge>
                                            <div className="flex items-center">
                                                <Star className="h-4 w-4 text-amber-500 fill-current" />
                                                <span className="ml-1 font-medium">{selectedDoctor.rating?.toFixed(1) || "4.5"}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    <div className="flex items-center mb-4">
                                        ...
                                        <h3 className="text-lg font-semibold">
                                            Giờ khám có sẵn - {formatDateVN(selectedDate)}
                                        </h3>
                                    </div>
                                                ...
                                                <div className="flex items-center p-4 bg-white rounded-xl shadow-sm">
                                                    ...
                                                    <div className="ml-4">
                                                        ...
                                                        <div className="flex items-center space-x-2 mt-1">
                                                            ...
                                                            <div className="flex items-center">
                                                                <Star className="h-4 w-4 text-amber-500 fill-current" />
                                                                <span className="ml-1">{selectedDoctor.rating?.toFixed(1) || "4.5"}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                    <div className="bg-white p-4 rounded-xl shadow-sm">
                                                        ...
                                                        <div className="font-medium text-gray-900">
                                                            {selectedDoctor.clinic || "Bệnh viện Đa khoa Quốc tế"}
                                                        </div>
                                                    </div>
                                                    <div className="bg-gradient-to-r from-green-500 to-emerald-500 text-white p-4 rounded-xl shadow-lg">
                                                        ...
                                                        <div className="text-2xl font-bold">
                                                            {selectedDoctor.consultationFee?.toLocaleString() || "300,000"} VNĐ
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <CardContent className="p-8">
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <span className="font-semibold">{selectedDate && formatDateVN(selectedDate)} • {selectedSlot?.startTime}</span>
                                        </div>
                                        <div className="flex items-center justify-between">
